...
export const sessionsService = {
  ...
  // their slots even after Session 1 has started or completed (409 only once Session 2 is
  // completed), and rolls the student back to the booking step so both sessions can be
