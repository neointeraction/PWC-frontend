import{g as e,u as S,a as y,j as r,l as j,R as v,b as k,B as c,c as p}from"./index-DquQY_gK.js";import{u as E,a as A,o as L,s as g}from"./types-B8oV3-br.js";import{u as T}from"./useMutation-BXZ6a0Mm.js";import{I as x}from"./Input-wL-_-s6l.js";const z={id:"user-super-admin",name:"Aarav Sharma (Super Admin)",email:"admin@pwc.com",role:"super_admin"},R={id:"user-admin-sunita",name:"Sunita Sharma",email:"sunita.sharma@pwc-global.com",role:"admin"},C={id:"user-counselor-mahesh",name:"Mahesh Pillai",email:"counselor@pwc.com",role:"counselor"},P={id:"user-student-aarav",name:"Aarav Sharma",email:"student@pwc.com",role:"student"},n="mock-jwt-token-12345",I={login:async o=>{if(await new Promise(t=>setTimeout(t,400)),o.email==="admin@pwc.com")return{user:z,token:n};if(o.email==="sunita.sharma@pwc-global.com")return{user:R,token:n};if(o.email==="counselor@pwc.com")return{user:C,token:n};if(o.email==="student@pwc.com")return{user:P,token:n};if(o.password.length>0)return{user:{id:"user-admin",name:o.email.split("@")[0].replace("."," ")||"kREATE Admin",email:o.email,role:"admin"},token:n};throw new Error("Invalid email or password")},logout:async()=>{await new Promise(o=>setTimeout(o,300))},refreshToken:async o=>{if(await new Promise(t=>setTimeout(t,400)),o===n)return n;throw new Error("Invalid token")}},O=e.div`
  display: flex;
  align-items: center;
