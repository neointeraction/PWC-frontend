import{g as i,bi as H,O as P,r as s,j as n,a_ as K,b0 as V,h as A}from"./index-BZPOwNvj.js";const N=i.div`
  display: flex;
...
`,ee=P.forwardRef(({label:e,options:t,value:r,defaultValue:k,onChange:g,placeholder:z="Select an option",error:f,fullWidth:E=!0,disabled:d=!1,name:R,id:C,style:D,className:O},L)=>{const[l,p]=s.useState(!1),[$,w]=s.useState(r!==void 0?r:k||""),[M,I]=s.useState({}),m=s.useRef(null),x=s.useRef(null),h=s.useRef(null);s.useEffect(()=>{r!==void 0&&w(r)},[r]);const u=s.useCallback(()=>{if(!x.current)return;const o=x.current.getBoundingClientRect(),a=window.innerHeight-o.bottom<220&&o.top>220;I({position:"fixed",left:`${o.left}px`,width:`${o.width}px`,zIndex:99999,...a?{bottom:`${window.innerHeight-o.top+4}px`,top:"auto",boxShadow:"0 -10px 25px -5px rgba(0, 0, 0, 0.2), 0 -8px 10px -6px rgba(0, 0, 0, 0.1)"}:{top:`${o.bottom+4}px`,bottom:"auto",boxShadow:"0 10px 25px -5px rgba(0, 0, 0, 0.2), 0 8px 10px -6px rgba(0, 0, 0, 0.1)"}})},[]);s.useEffect(()=>{if(!l)return;u();const o=()=>{u()};return window.addEventListener("scroll",o,!0),window.addEventListener("resize",o),()=>{window.removeEventListener("scroll",o,!0),window.removeEventListener("resize",o)}},[l,u]),s.useEffect(()=>{if(!l)return;const o=c=>{var v,j;const a=c.target,T=(v=m.current)==null?void 0:v.contains(a),F=(j=h.current)==null?void 0:j.contains(a);!T&&!F&&p(!1)};return document.addEventListener("mousedown",o),()=>{document.removeEventListener("mousedown",o)}},[l]);const y=()=>{d||(l||u(),p(o=>!o))},b=t.find(o=>o.value===$),W=o=>{d||o.disabled||(w(o.value),p(!1),g&&g({target:{value:o.value,name:R}}))},B=o=>{d||(o.key==="Enter"||o.key===" "?(o.preventDefault(),y()):o.key==="Escape"&&p(!1))},S=C||`select-${Math.random().toString(36).slice(2,9)}`;return n.jsxs(N,{$fullWidth:E,style:D,className:O,ref:L,children:[e&&n.jsx(U,{htmlFor:S,children:e}),n.jsxs(_,{ref:m,children:[n.jsxs(q,{ref:x,id:S,type:"button",$isOpen:l,$hasError:!!f,$isDisabled:d,disabled:d,onClick:y,onKeyDown:B,"aria-haspopup":"listbox","aria-expanded":l,children:[n.jsx(G,{$isPlaceholder:!b,children:b?b.label:z}),n.jsx(J,{$isOpen:l,children:n.jsx(K,{size:18})})]}),l&&V.createPortal(n.jsx(Q,{ref:h,role:"listbox",style:M,children:t.map(o=>{const c=o.value===$,a=!!o.disabled;return n.jsxs(X,{role:"option","aria-selected":c,"aria-disabled":a,$isSelected:c,$isDisabled:a,onClick:()=>W(o),children:[n.jsxs("span",{children:[o.label,a&&n.jsx(Y,{children:"(Coming Soon)"})]}),c&&n.jsx(A,{size:16})]},o.value)})}),document.body)]}),f&&n.jsx(Z,{role:"alert",children:f})]})});ee.displayName="Select";export{ee as S};
