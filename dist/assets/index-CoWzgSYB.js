import{g as c,j as n,w as N,e as U,x as O,B as A,r as M,y as W,z as me,A as R,C as pe,D as ge,a as xe,E as he,F as ye,G as Q,H,I as J,J as fe,K as be,M as we}from"./index-CQIsxyVc.js";import{u as je}from"./useQuery-BLKPeCfm.js";import{u as I}from"./useMutation-BpdSDJqm.js";import{P as Ce}from"./PageHeader-BviCOs3E.js";import{C as ve}from"./Card-DBSouhuv.js";import{I as v}from"./Input-BTc8i6Fv.js";import{T as Te}from"./Table-5vznqd6X.js";import{B as C}from"./Badge-CYwePiJT.js";import{S as D}from"./Select-DE5um1RR.js";import"./Table.styles-BoafHu4m.js";import{T as Ee,a as Ae,b as $e,C as Se,A as ze}from"./FileUpload.styles-Y1Fz2BvR.js";import"./Breadcrumb-CQhppWVK.js";import{M as F}from"./Modal-Co5MyHOO.js";import"./ConfirmDialog-Crq_Y4vl.js";import"./Checkbox-BLQlg_i7.js";import{A as ke}from"./AlertModal-BPlRnRm3.js";import{T as k}from"./Tooltip-5yEO6vap.js";import"./SuccessModal.styles-BtFfVjkK.js";import{u as ne,a as te,o as se,e as L,s as b,b as ae}from"./types-Dn1xv1uh.js";import"./Card.styles-riY3W49l.js";import"./Badge.styles-MB7Dm0Fa.js";import"./SuccessModal-BavKoXSP.js";const Pe=[{id:"usr-101",name:"Sunita Sharma",email:"sunita.sharma@pwc-global.com",username:"sunita.sharma@pwc-global.com",phone:"+1 (555) 019-2834",userCategory:"pwc",roleLabel:"Super Admin",organizationName:"kREATE Global Engine",status:"active",createdAt:"2025-01-15",lastActive:"Today, 10:42 AM",generatedPassword:"kREATE@User2026!"},{id:"usr-102",name:"Vikram Mehta (View Only)",email:"viewer@pwc.com",username:"viewer@pwc.com",phone:"+91 98765 43210",userCategory:"pwc",roleLabel:"View Only Tenant",organizationName:"kREATE Global Engine",status:"active",isViewOnly:!0,createdAt:"2025-02-01",lastActive:"Today, 11:15 AM",generatedPassword:"ViewOnly@Key2026!"},{id:"usr-103",name:"Pooja Verma (View Only)",email:"pooja.verma@pwc.com",username:"pooja.verma@pwc.com",phone:"+91 98123 45678",userCategory:"pwc",roleLabel:"View Only Tenant",organizationName:"kREATE Global Engine",status:"active",isViewOnly:!0,createdAt:"2025-02-05",lastActive:"Yesterday, 04:20 PM",generatedPassword:"ViewOnly@Pooja2026!"}];let h=Pe.filter(e=>e.userCategory!=="institution"&&e.userCategory!=="counselor");const Y=e=>{const a=e==="pwc"?"kREATE":e==="view_only"?"ViewOnly":e==="counselor"?"Cnslt":"Inst",s=Math.floor(1e3+Math.random()*9e3);return`${a}@Key${s}!`},z={getAll:async(e={})=>{await new Promise(o=>setTimeout(o,300));let a=[...h];if(e.category&&e.category!=="all"&&(a=a.filter(o=>o.userCategory===e.category)),e.status&&e.status!=="all"&&(a=a.filter(o=>o.status===e.status)),e.search){const o=e.search.toLowerCase();a=a.filter(u=>u.name.toLowerCase().includes(o)||u.email.toLowerCase().includes(o)||u.roleLabel.toLowerCase().includes(o)||u.organizationName&&u.organizationName.toLowerCase().includes(o))}const s=e.page??1,r=e.limit??10,t=a.length,d=Math.ceil(t/r),p=(s-1)*r;return{data:a.slice(p,p+r),total:t,page:s,limit:r,totalPages:d}},getById:async e=>{await new Promise(s=>setTimeout(s,200));const a=h.find(s=>s.id===e);if(!a)throw new Error("Tenant user not found");return{...a}},getByEmailOrUsername:async e=>{const a=e.toLowerCase().trim();return h.find(s=>s.email.toLowerCase()===a||s.username&&s.username.toLowerCase()===a)},create:async e=>{if(await new Promise(r=>setTimeout(r,400)),e.userCategory==="pwc"&&h.find(t=>t.userCategory==="pwc"))throw new Error("A kREATE User already exists. Only 1 kREATE User is allowed on the system.");const a=e.generatedPassword||Y(e.userCategory),s={id:`usr-${Date.now()}`,...e,username:e.username||e.email,generatedPassword:a,createdAt:new Date().toISOString().slice(0,10),lastActive:"Just now"};return h=[s,...h],s},update:async(e,a)=>{await new Promise(t=>setTimeout(t,300));const s=h.findIndex(t=>t.id===e);if(s===-1)throw new Error("Tenant user not found");const r={...h[s],...a};return h[s]=r,r},regeneratePassword:async e=>{const a=h.find(r=>r.id===e);if(!a)throw new Error("Tenant user not found");const s=Y(a.userCategory);return z.update(e,{generatedPassword:s})},delete:async e=>{await new Promise(a=>setTimeout(a,300)),h=h.filter(a=>a.id!==e)},updateStatus:async(e,a)=>z.update(e,{status:a})},Re=c.div`
  display: flex;
...
`,Je=()=>{const e=N(),a=U(),{isCredentialsModalOpen:s,closeCredentialsModal:r,selectedUser:t}=O(),[d,p]=M.useState(!1),w=I({mutationFn:g=>z.regeneratePassword(g),onSuccess:g=>{e.invalidateQueries({queryKey:["tenant-records"]}),a.success("Credentials Regenerated",`New password generated for ${g.name}.`)},onError:()=>{a.error("Error","Failed to regenerate credentials.")}});if(!t)return null;const o=(g,j)=>{navigator.clipboard.writeText(g),a.info("Copied to Clipboard",`${j} has been copied.`)},u=t.username||t.email,y=t.generatedPassword||"kREATE@User2026!";return n.jsx(F,{isOpen:s,onClose:r,title:"Tenant Login Credentials",subtitle:`Security login details for ${t.name}`,size:"md",children:n.jsxs(re,{children:[n.jsxs(_,{children:[n.jsx("div",{children:n.jsx(Be,{children:t.name})}),n.jsxs(C,{variant:t.userCategory==="pwc"?"primary":"info",children:[t.userCategory.toUpperCase()," USER"]})]}),n.jsxs(He,{children:[n.jsxs(X,{children:[n.jsx("label",{children:"Login Email / Username"}),n.jsxs(Z,{children:[n.jsx(ee,{children:u}),n.jsx(B,{title:"Copy Username",onClick:()=>o(u,"Username/Email"),children:n.jsx(W,{size:18})})]})]}),n.jsxs(X,{children:[n.jsx("label",{children:"Generated Password"}),n.jsxs(Z,{children:[n.jsx(ee,{children:d?y:"••••••••••••"}),n.jsx(B,{title:d?"Hide Password":"Show Password",onClick:()=>p(!d),children:d?n.jsx(me,{size:18}):n.jsx(R,{size:18})}),n.jsx(B,{title:"Copy Password",onClick:()=>o(y,"Password"),children:n.jsx(W,{size:18})})]})]})]}),n.jsxs(_,{children:[n.jsx(A,{variant:"secondary",size:"sm",leftIcon:n.jsx(pe,{size:16}),isLoading:w.isPending,onClick:()=>w.mutate(t.id),children:"Regenerate Password"}),n.jsx(A,{variant:"primary",size:"sm",leftIcon:n.jsx(ge,{size:16}),onClick:()=>{const g=`kREATE Platform Credentials:
Name: ${t.name}
Username: ${u}
Password: ${y}
Portal: kREATE Career Counselling Platform`;o(g,"Full Credentials Package")},children:"Copy Full Credentials Package"})]})]})})},bn=()=>{const e=N(),a=U(),{user:s}=xe(),r=!!(s!=null&&s.isViewOnly),{activeCategory:t,setActiveCategory:d,searchQuery:p,setSearchQuery:w,openAddModal:o,openEditModal:u,openViewModal:y,openCredentialsModal:g}=O(),[j,f]=M.useState(1),[T,$]=M.useState(10),[x,m]=M.useState(null),{data:l,isLoading:S}=je({queryKey:["tenant-records",t,p,j,T],queryFn:()=>z.getAll({category:t,search:p,page:j,limit:T})}),G=I({mutationFn:z.delete,onSuccess:()=>{e.invalidateQueries({queryKey:["tenant-records"]}),a.success("Tenant User Deleted","Successfully removed tenant user record."),m(null)},onError:()=>{a.error("Error","Failed to delete tenant user record."),m(null)}}),oe=i=>{m(i)},le=()=>{x&&G.mutate(x.id)},ce=i=>{switch(i){case"pwc":return n.jsxs(C,{variant:"primary",children:[n.jsx(V,{children:n.jsx(Q,{size:14})}),"kREATE"]});case"institution":return n.jsxs(C,{variant:"info",children:[n.jsx(V,{children:n.jsx(H,{size:14})}),"Institution"]});case"counselor":return n.jsxs(C,{variant:"success",children:[n.jsx(V,{children:n.jsx(J,{size:14})}),"Counselor"]})}},de=[{key:"name",header:"Tenant Name & Contact",render:i=>n.jsxs(Ne,{children:[n.jsx(Ue,{children:i.name}),n.jsx(Ie,{children:i.email})]})},{key:"userCategory",header:"User Type",render:i=>n.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"6px",flexWrap:"wrap"},children:[ce(i.userCategory),i.isViewOnly&&n.jsxs(C,{variant:"warning",children:[n.jsx(V,{children:n.jsx(R,{size:14})}),"View Only"]})]})},{key:"organizationName",header:"Organization / Institution",render:i=>i.organizationName||"kREATE Global Engine"},{key:"status",header:"Status",render:i=>n.jsx(C,{variant:i.status==="active"?"success":i.status==="pending"?"warning":"default",dot:!0,children:i.status})},{key:"lastActive",header:"Last Active",render:i=>i.lastActive||"N/A"},{key:"actions",header:"Actions",render:i=>{var q,K;return n.jsx(Le,{children:r?n.jsx(k,{content:"View Profile",children:n.jsx(P,{"aria-label":"View Profile",onClick:()=>y(i),children:n.jsx(R,{size:16})})}):n.jsxs(n.Fragment,{children:[n.jsx(k,{content:"View Credentials",children:n.jsx(P,{"aria-label":"View Credentials",onClick:()=>g(i),children:n.jsx(fe,{size:16})})}),n.jsx(k,{content:"View Profile",children:n.jsx(P,{"aria-label":"View Profile",onClick:()=>y(i),children:n.jsx(R,{size:16})})}),n.jsx(k,{content:"Edit Tenant",children:n.jsx(P,{"aria-label":"Edit Tenant",onClick:()=>u(i),children:n.jsx(be,{size:16})})}),n.jsx(k,{content:((l==null?void 0:l.total)??((q=l==null?void 0:l.data)==null?void 0:q.length)??0)<=1?"Cannot delete the only tenant":"Delete Tenant",children:n.jsx(P,{"aria-label":"Delete Tenant",disabled:((l==null?void 0:l.total)??((K=l==null?void 0:l.data)==null?void 0:K.length)??0)<=1,onClick:()=>oe(i),children:n.jsx(we,{size:16})})})]})})}}],ue=[{id:"pwc",label:"kREATE",icon:n.jsx(Q,{size:18})},{id:"institution",label:"Institution",icon:n.jsx(H,{size:18}),disabled:!0,comingSoon:!0},{id:"counselor",label:"Counselor",icon:n.jsx(J,{size:18}),disabled:!0,comingSoon:!0}];return n.jsxs(Re,{children:[n.jsx(Ce,{title:"Tenant Management",breadcrumbs:[{label:"Dashboard",href:"/dashboard"},{label:"Tenant Management"}]}),n.jsxs(ve,{children:[r&&n.jsxs("div",{style:{padding:"12px 16px",marginBottom:"16px",borderRadius:"4px",backgroundColor:"#fffbeb",border:"1px solid #fde68a",color:"#78350f",fontSize:"14px",fontWeight:500,display:"flex",alignItems:"center",gap:"10px"},children:[n.jsx(R,{size:20,style:{color:"#d97706",flexShrink:0}}),n.jsxs("span",{children:[n.jsx("strong",{children:"View-Only Mode Active:"})," You are logged in with read-only permissions. Adding, editing, and deleting tenants is restricted."]})]}),n.jsx(De,{tabs:ue,activeTab:t==="all"?"pwc":t,onChange:i=>{d(i),f(1)},layoutId:"tenantManagementTabs"}),n.jsxs(Me,{children:[n.jsx(Oe,{children:n.jsx(v,{placeholder:"Search tenants by name, email, role, or institution...",leftIcon:n.jsx(he,{size:18}),value:p,onChange:i=>{w(i.target.value),f(1)}})}),!r&&n.jsx(A,{leftIcon:n.jsx(ye,{size:18}),onClick:o,children:"Add New Tenant"})]}),n.jsx(Te,{columns:de,data:(l==null?void 0:l.data)??[],isLoading:S,keyExtractor:i=>i.id,pagination:l?{page:l.page,totalPages:l.totalPages,total:l.total,limit:l.limit,onPageChange:i=>f(i),onLimitChange:i=>{$(i),f(1)}}:void 0})]}),n.jsx(qe,{}),n.jsx(We,{}),n.jsx(Qe,{}),n.jsx(Je,{}),n.jsx(ke,{isOpen:!!x,onClose:()=>m(null),onConfirm:le,title:"Delete Tenant User",description:`Are you sure you want to delete ${x==null?void 0:x.name}? This action cannot be undone.`,variant:"danger",confirmText:"Delete",cancelText:"Cancel",isLoading:G.isPending})]})};export{bn as TenantManagementPage};
