...
`,w=o.div`
  ...
  color: ${({theme:e})=>e.colors.textSecondary};
`,$=({isOpen:e,onClose:i,studentId:n,studentName:h})=>{const{data:t,isLoading:g}=p({queryKey:["pre-counselling-form",n],queryFn:()=>n?y.getPreCounsellingForm(n):null,enabled:!!n&&e});return s.jsx(j,{isOpen:e,onClose:i,title:`Pre-Counselling Answers: ${h}`,size:"md",children:g?s.jsx(u,{children:s.jsx(x,{})}):t?s.jsxs(u,{children:[s.jsxs(d,{children:[s.jsx(a,{children:"Career Interests"}),t.careerInterests.length>0?s.jsx(m,{children:t.careerInterests.map((r,l)=>s.jsx("li",{children:r},l))}):s.jsx(c,{children:"None specified"})]}),s.jsxs(d,{children:[s.jsx(a,{children:"Strengths"}),t.strengths.length>0?s.jsx(m,{children:t.strengths.map((r,l)=>s.jsx("li",{children:r},l))}):s.jsx(c,{children:"None specified"})]}),s.jsxs(d,{children:[s.jsx(a,{children:"Preferred Subjects"}),t.preferredSubjects.length>0?s.jsx(m,{children:t.preferredSubjects.map((r,l)=>s.jsx("li",{children:r},l))}):s.jsx(c,{children:"None specified"})]}),s.jsxs(d,{children:[s.jsx(a,{children:"Additional Notes"}),s.jsx(c,{children:t.additionalNotes||"None specified"})]})]}):s.jsx(w,{children:"No pre-counselling form answers found for this student."})})};export{$ as P};
