...
`,Jt=({steps:e,searchQuery:t,onSearchChange:s,actions:r})=>i.jsxs(Ut,{children:[i.jsx(qt,{children:e.map((a,c)=>{const l=c===e.length-1;return i.jsxs(Bi.Fragment,{children:[i.jsx(Ht,{$active:l,onClick:a.onClick,children:a.label}),!l&&i.jsx(Nt,{children:"›"})]},c)})}),i.jsxs(Ot,{children:[i.jsx(Qt,{children:i.jsx(St,{value:t,onChange:s,placeholder:"Search a career, role, exam..."})}),r]})]}),Kt=n.div`
  display: flex;
...
`,ie=n.span`
  ...
  font-size: ${({theme:e})=>e.fontSize.xs};
  font-weight: 600;
`,Xn=({role:e})=>i.jsxs(Kn,{children:[i.jsxs(Wn,{children:[i.jsxs(Vn,{children:[i.jsx(Ue,{}),i.jsx(Ue,{}),i.jsx(Ue,{})]}),i.jsxs(Yn,{children:[i.jsxs(qe,{children:[i.jsx(He,{children:"10+2"}),i.jsx(Ne,{children:"12th — Any stream"}),i.jsx(Qe,{children:e.minQual10th12thRecommendedSubjects||"12th Standard Fine Arts / Computer Application"})]}),i.jsxs(qe,{children:[i.jsx(He,{children:"GRADUATE"}),i.jsx(Ne,{children:"BDes / BFA / Relevant Degree"}),i.jsx(Qe,{children:"Recommended focus: UI/UX Design & Digital Arts"})]}),i.jsxs(qe,{children:[i.jsx(He,{children:"POST-GRADUATE"}),i.jsx(Ne,{children:"MDes, MFA, Design Management"}),i.jsx(Qe,{children:"Advanced Human-Computer Interaction"})]})]})]}),i.jsxs(_n,{children:[i.jsxs(ri,{children:[i.jsx(oi,{children:"Certifications — Student Level"}),i.jsxs(ai,{children:[i.jsx(ie,{children:"Adobe Photoshop Skills"}),i.jsx(ie,{children:"Canva Design Mastery"}),i.jsx(ie,{children:"Graphic Design Fundamentals"})]})]}),i.jsxs(ri,{children:[i.jsx(oi,{children:"Certifications — Undergraduate Level"}),i.jsxs(ai,{children:[i.jsx(ie,{children:"Adobe Certified Professional"}),i.jsx(ie,{children:"UI/UX Design Specialization"}),i.jsx(ie,{children:"Motion Graphics & After Effects"}),i.jsx(ie,{children:"UX Tools"})]})]})]})]}),Zn=n.div`
  display: flex;
  flex-direction: column;
  gap: ${({theme:e})=>e.spacing.lg};
`,li=n.p`
...
`,$r=n.div`
  ...
  gap: ${({theme:e})=>e.spacing.sm};
  width: 100%;
`,wr=({isOpen:e,onClose:t})=>{const s=We(),r=Ve(),a=y.useRef(null),[c,l]=y.useState(null),[h,u]=y.useState(!1),[b,$]=y.useState([]),[E,C]=y.useState(null),k=D({mutationFn:j.bulkCreate,onSuccess:m=>{s.invalidateQueries({queryKey:["careers"]}),r.success("18-Spec Import Successful",`Successfully imported ${m.count} career profiles.`),L(),t()},onError:m=>{r.error("Bulk upload failed",m.message)}}),L=()=>{l(null),$([]),C(null),u(!1),a.current&&(a.current.value="")},q=()=>{L(),t()},te=()=>{const m=["Career Cluster","Industry","Domain","Job Role","AI Resilience Grading","AI Resilience Comment","One-line Description","Top Companies Recruiting","Approx Salary Range (India)","Global Salary Range","Minimum Qualification (10th/12th) + Recommended Subjects","Minimum Qualification (Grad) + Recommended Subjects","Entrance Exams (UG Level)","Minimum Qualification (PG) + Recommended Subjects","Entrance Exams (PG Level)","Certifications - Students","Certifications - UG","Top Courses to Study (UG + PG + Certifications)"].map(T=>`"${T}"`).join(",")+`
