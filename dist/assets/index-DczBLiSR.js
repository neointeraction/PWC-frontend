...
`,Er=n.div`
  ...
  gap: ${({theme:e})=>e.spacing.xs};
  margin-top: ${({theme:e})=>e.spacing.md};
`,oo=()=>{const e=Ve(),t=Ye(),[s,r]=y.useState(null),{data:a,isLoading:c}=Y({queryKey:["pending-ratifications"],queryFn:w.getPendingRatifications}),l=D({mutationFn:w.ratify,onSuccess:()=>{e.invalidateQueries({queryKey:["pending-ratifications"]}),e.invalidateQueries({queryKey:["careers"]}),t.success("Career Ratified!","The submission has been ratified and added to the Career Library."),r(null)},onError:()=>t.error("Ratification failed")}),h=D({mutationFn:w.rejectRatification,onSuccess:()=>{e.invalidateQueries({queryKey:["pending-ratifications"]}),t.info("Career Submission Rejected","The submission has been rejected."),r(null)},onError:()=>t.error("Rejection failed")}),u=[{key:"careerName",header:"Job Role (Proposed)",render:b=>i.jsxs("div",{children:[i.jsx(Dr,{children:b.careerName}),i.jsxs(Lr,{children:["Submitted: ",b.submittedAt]})]})},{key:"suggestedCategory",header:"Career Cluster",render:b=>i.jsx(de,{variant:"primary",children:b.suggestedCategory})},{key:"sourceTenant",header:"Source Institution",render:b=>i.jsx(Tr,{children:b.sourceTenant})},{key:"status",header:"Ratification Status",render:b=>i.jsx(de,{variant:b.status==="ratified"?"success":b.status==="rejected"?"danger":"warning",dot:!0,children:b.status.charAt(0).toUpperCase()+b.status.slice(1)})},{key:"actions",header:"Actions",render:b=>i.jsxs(St,{children:[i.jsx(H,{size:"sm",variant:"secondary",leftIcon:i.jsx(mr,{size:15}),onClick:()=>r(b),children:"Audit Details"}),b.status==="pending"&&i.jsxs(i.Fragment,{children:[i.jsx(H,{size:"sm",variant:"primary",leftIcon:i.jsx(ui,{size:15}),isLoading:l.isPending,onClick:()=>l.mutate(b.id),children:"Ratify & Publish"}),i.jsx(H,{size:"sm",variant:"secondary",leftIcon:i.jsx(pi,{size:15}),isLoading:h.isPending,onClick:()=>h.mutate(b.id),children:"Reject"})]})]})}];return i.jsxs("div",{children:[i.jsx(Si,{title:"Pending Career Ratifications",subtitle:"Review, audit, and ratify institution-submitted niche career pathways",breadcrumbs:[{label:"Dashboard",href:We.DASHBOARD},{label:"Career Library",href:We.CAREER_LIBRARY},{label:"Pending Ratifications"}]}),i.jsx(Xe,{children:!a||a.length===0?i.jsx(Ct,{icon:i.jsx(Ri,{size:28}),title:"All caught up!",description:"There are no pending career ratifications at this time."}):i.jsx(vi,{columns:u,data:a,isLoading:c,keyExtractor:b=>b.id})}),s&&i.jsx(_e,{isOpen:!!s,onClose:()=>r(null),title:`Ratification Review: ${s.careerName}`,subtitle:"Audit proposed custom career details before publishing to platform library",size:"md",children:i.jsxs(Ir,{children:[i.jsxs(Le,{children:[i.jsx("span",{children:"Proposed Job Role (Primary Key)"}),i.jsx("p",{children:s.careerName})]}),i.jsxs(Le,{children:[i.jsx("span",{children:"Suggested Career Cluster"}),i.jsx("p",{children:s.suggestedCategory})]}),i.jsxs(Le,{children:[i.jsx("span",{children:"Source Institution"}),i.jsx("p",{children:s.sourceTenant})]}),i.jsxs(Le,{children:[i.jsx("span",{children:"Submitted Description"}),i.jsx("p",{children:s.description})]}),i.jsxs(Er,{children:[i.jsx(H,{variant:"secondary",onClick:()=>r(null),children:"Close"}),s.status==="pending"&&i.jsxs(i.Fragment,{children:[i.jsx(H,{variant:"secondary",leftIcon:i.jsx(pi,{size:16}),onClick:()=>h.mutate(s.id),children:"Reject Submission"}),i.jsx(H,{variant:"primary",leftIcon:i.jsx(ui,{size:16}),onClick:()=>l.mutate(s.id),children:"Ratify & Publish"})]})]})]})})]})};export{ro as CareerListPage,oo as PendingRatificationsPage};
