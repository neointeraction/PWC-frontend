import{g as r,bd as u,r as d,p as b,j as e,bB as f,aU as g,aw as m}from"./index-D-K1gLqS.js";const h=u`
  from { opacity: 0; }
  to { opacity: 1; }
`,y=r.div`
  position: fixed;
...
`,E=r.div`
  ...
  flex-shrink: 0;
`,B=({isOpen:o,onClose:t,title:a,subtitle:l,size:c="md",footer:n,children:x,closeOnBackdrop:p=!0})=>{const s=d.useCallback(i=>{i.key==="Escape"&&t()},[t]);return d.useEffect(()=>(o&&(document.addEventListener("keydown",s),document.body.style.overflow="hidden"),()=>{document.removeEventListener("keydown",s),document.body.style.overflow=""}),[o,s]),b.createPortal(e.jsx(f,{children:o&&e.jsx(y,{onClick:p?t:void 0,role:"dialog","aria-modal":"true","aria-labelledby":"modal-title",children:e.jsx(g.div,{initial:{opacity:0,scale:.95,y:8},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.95,y:8},transition:{duration:.18,ease:"easeOut"},style:{width:"100%",display:"flex",justifyContent:"center"},onClick:i=>i.stopPropagation(),children:e.jsxs($,{$size:c,children:[(a||l)&&e.jsxs(k,{children:[e.jsxs("div",{children:[a&&e.jsx(v,{id:"modal-title",children:a}),l&&e.jsx(w,{children:l})]}),e.jsx(j,{onClick:t,"aria-label":"Close modal",children:e.jsx(m,{size:20})})]}),e.jsx(M,{children:e.jsx(C,{children:x})}),n&&e.jsx(E,{children:n})]})})})}),document.body)};export{B as M};
