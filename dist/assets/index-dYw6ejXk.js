import{d as te,j as t,R as H,b8 as ue,J as se,b9 as ge,B as a,f as _,g as s,aV as V,ba as xe,u as fe,a as he,r as n,K as be,c as $,V as Se,bb as ye,a5 as $e,a$ as je,al as J,bc as Ce,aX as Z}from"./index-DquQY_gK.js";import{B as U}from"./Badge-IsTjrd75.js";import{u as ke,a as ve,o as we,s as b}from"./types-B8oV3-br.js";import{M as ze}from"./Modal-BB0US1Ku.js";import{I as v}from"./Input-wL-_-s6l.js";import{S as ee}from"./Select-BWCmQJaH.js";import"./Badge.styles-CPrEOBEn.js";const Ie=we({fullName:b().min(1,"Full name is required"),email:b().email("Enter a valid email"),schoolName:b().min(1,"School name is required"),grade:b().min(1,"Grade is required"),guardianName:b().min(1,"Guardian name is required"),guardianPhone:b().min(1,"Guardian phone is required"),targetStream:b().min(1,"Select target stream")}),Fe=s.form`
  display: flex;
