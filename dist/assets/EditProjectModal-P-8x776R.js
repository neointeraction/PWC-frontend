import{j as t,h as B,g as s,as as z,r as p,e as I,M as W,B as $,l as K,w as O,i as Z,at as H,au as X,I as Y,av as ee}from"./index-BVWJ6WpZ.js";import{u as te}from"./useMutation-BQUtJgjz.js";import{M as ae}from"./Modal-Db5Ns9rg.js";import{c as se,d as ne,e as oe,f as ie,g as le,h as re,i as ce}from"./FileUpload.styles-C0j1LOld.js";import{I as w}from"./Input-DVW4Hyzv.js";import{S as de}from"./Select-BodBe-a6.js";import{D as L}from"./DatePicker-CtHX62Mn.js";import{p as P}from"./project.service-RU6EL_sY.js";import{p as V,F as q}from"./FileUpload-B40XrQVg.js";import{T as U}from"./Table-BWgMaM_p.js";import{T as Q}from"./Tooltip-C1eXP5zv.js";import{B as me}from"./Badge-DW76FgrL.js";const ue=({steps:e,activeStep:a})=>{const f=c=>c<a?"completed":c===a?"active":"upcoming";return t.jsx(se,{children:e.map((c,h)=>{const o=f(h),r=h===e.length-1;return t.jsxs(ne,{children:[t.jsx(oe,{$state:o,children:o==="completed"?t.jsx(B,{size:16}):c.icon||h+1}),t.jsxs(ie,{children:[t.jsx(le,{$active:o==="active"||o==="completed",children:c.label}),c.description&&t.jsx(re,{children:c.description})]}),!r&&t.jsx(ce,{$completed:h<a})]},c.label)})})},Le=s.div`
  display: flex;
