import{g as r,bh as b,r as i,j as t,bI as k,h as z}from"./index-DdWrmQ5m.js";const j=r.div`
  display: inline-flex;
...
`,W=i.forwardRef(({label:o,error:e,checked:s,defaultChecked:n=!1,indeterminate:a=!1,disabled:c=!1,id:u,className:h,style:y,onChange:p,...m},v)=>{const l=i.useRef(null);i.useImperativeHandle(v,()=>l.current);const[w,x]=i.useState(s!==void 0?s:n);i.useEffect(()=>{s!==void 0&&x(s)},[s]),i.useEffect(()=>{l.current&&(l.current.indeterminate=!!a)},[a]);const S=f=>{c||(s===void 0&&x(f.target.checked),p&&p(f))},g=u||`checkbox-${Math.random().toString(36).slice(2,9)}`,d=s!==void 0?s:w;return t.jsxs(j,{children:[t.jsxs(C,{$disabled:c,htmlFor:g,className:h,style:y,children:[t.jsx($,{ref:l,type:"checkbox",id:g,checked:d,disabled:c,onChange:S,...m}),t.jsx(R,{$checked:d,$indeterminate:a,$hasError:!!e,$disabled:c,children:a?t.jsx(k,{size:14}):d&&t.jsx(z,{size:14})}),o&&t.jsx(H,{children:o})]}),e&&t.jsx(T,{role:"alert",children:e})]})});W.displayName="Checkbox";const P=r.div`
  display: flex;
  align-items: center;
...
`;export{K as A,W as C,P,L as R,M as S,F as T,E as a,B as b,A as c,G as d,N as e,O as f,q as g,D as h,J as i,Q as j};
