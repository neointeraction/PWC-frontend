import{r as a,j as t,f as R,H as A,B as $,G as F,g as o,aw as D,aF as Q,u as U,y as K,d as J,c as w,O as V,aG as X}from"./index-BLYAqq6p.js";import{u as E}from"./Modal.styles-BRO_TcLB.js";import{u as Y}from"./useMutation-CAd7Y0xf.js";import{P as Z}from"./PageHeader-CT1IpXxa.js";import{C as _}from"./Card-BEIiB9ZF.js";import{I as h}from"./Input-Bcja1afE.js";import{T as B}from"./Table-D4O82cND.js";import{B as N}from"./Badge-BFcoyLUs.js";import{p as k}from"./project.service-CqiMKOES.js";import{M as ee}from"./Modal-PTosz82V.js";import"./Table.styles-DkGFl9kv.js";import"./Select-HMUU6vG0.js";import"./Badge.styles-DWG4Eh3Z.js";import"./counselors.mock---5XGzUI.js";const te=o.div`
  display: flex;
...
`,ue=({isOpen:e,onClose:r,session:i,onSave:S,isSaving:p})=>{const[b,f]=a.useState(""),[d,m]=a.useState([]),[g,j]=a.useState(""),[y,x]=a.useState(1),n=10,[c,u]=a.useState(""),[v,L]=a.useState(""),[T,M]=a.useState(""),[I]=a.useState("12th");a.useEffect(()=>{if(i){const s=i.timeSlots.find(l=>l.isSelected)||i.timeSlots[0];f((s==null?void 0:s.id)||""),m([...i.assignedStudents]),j(""),x(1)}},[i]);const W=()=>{!c.trim()||!v.trim()||(m(s=>[{name:c.trim(),email:v.trim(),mobile:T.trim()||"+91 98000 00000",grade:I},...s]),u(""),L(""),M(""))},G=s=>{m(l=>l.filter(O=>O.email!==s))},C=a.useMemo(()=>{if(!g)return d;const s=g.toLowerCase();return d.filter(l=>l.name.toLowerCase().includes(s)||l.email.toLowerCase().includes(s)||l.mobile.toLowerCase().includes(s))},[d,g]),q=()=>{i&&S(i.id,b,d)},H=[{key:"email",header:"Action",render:s=>t.jsx(ce,{onClick:()=>G(s.email),title:"Remove Student",children:t.jsx(D,{size:16})})},{key:"name",header:"Student Name"},{key:"email",header:"Email"},{key:"mobile",header:"Mobile"},{key:"grade",header:"Grade",render:s=>t.jsx(N,{variant:"default",children:s.grade})}];return i?t.jsx(ee,{isOpen:e,onClose:r,title:`Modify Session - ${i.counselorName}`,subtitle:`Select preferred time slot and manage ${d.length} assigned students for ${i.counselorName}`,size:"xl",footer:t.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:"8px",width:"100%"},children:[t.jsx($,{variant:"secondary",onClick:r,disabled:p,children:"Cancel"}),t.jsxs($,{onClick:q,isLoading:p,children:["Save Changes (",d.length," Students)"]})]}),children:t.jsxs(te,{children:[t.jsxs("div",{children:[t.jsx(z,{children:"Available Time Slots (Select One)"}),t.jsx(se,{children:i.timeSlots.map(s=>{const l=s.id===b;return t.jsxs(oe,{$isSelected:l,onClick:()=>f(s.id),children:[t.jsx(re,{$isSelected:l,children:s.time}),l&&t.jsx(ie,{children:t.jsx(R,{size:14})})]},s.id)})})]}),t.jsxs("div",{children:[t.jsxs(ne,{children:[t.jsxs(z,{style:{margin:0},children:["Assigned Students (",d.length,")"]}),t.jsx("div",{style:{width:"260px"},children:t.jsx(h,{placeholder:"Search assigned students...",leftIcon:t.jsx(A,{size:15}),value:g,onChange:s=>{j(s.target.value),x(1)}})})]}),t.jsxs(ae,{children:[t.jsx(z,{style:{fontSize:"12px",marginBottom:"8px"},children:"Quick Add Student to Session"}),t.jsxs(de,{children:[t.jsx(h,{placeholder:"Student Name",value:c,onChange:s=>u(s.target.value)}),t.jsx(h,{placeholder:"Email Address",type:"email",value:v,onChange:s=>L(s.target.value)}),t.jsx(h,{placeholder:"Mobile Number",value:T,onChange:s=>M(s.target.value)}),t.jsx($,{size:"sm",variant:"secondary",leftIcon:t.jsx(F,{size:16}),onClick:W,children:"Add Student"})]})]}),t.jsx(le,{children:t.jsx(B,{columns:H,data:C,keyExtractor:s=>s.email,emptyMessage:"No students found.",pagination:{page:y,limit:n,total:C.length,totalPages:Math.ceil(C.length/n)||1,onPageChange:x}})})]})]})}):null},me=o.div`
  display: flex;
  flex-direction: column;
`,pe=o.div`
  display: flex;
