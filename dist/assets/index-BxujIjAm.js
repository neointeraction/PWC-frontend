import{r as a,j as s,f as R,H as A,B as $,G as D,g as o,as as F,aB as Q,u as U,y as K,d as J,c as w,O as V,aC as X}from"./index-BIfikPqx.js";import{u as E}from"./useQuery-C5DYjsD-.js";import{u as Y}from"./useMutation-Biwx1r6Q.js";import{P as Z}from"./PageHeader-hWMsFgih.js";import{C as _}from"./Card-DIV6FLs6.js";import{I as f}from"./Input-Bs3wSDGO.js";import{M as ee,T as B,B as N}from"./Modal-CHcOI8H4.js";import{p as k}from"./project.service-CqiMKOES.js";import"./Modal.styles-DEidvQxJ.js";import"./counselors.mock---5XGzUI.js";const se=o.div`
  display: flex;
...
`,ue=({isOpen:e,onClose:r,session:n,onSave:S,isSaving:m})=>{const[b,h]=a.useState(""),[d,p]=a.useState([]),[g,j]=a.useState(""),[y,x]=a.useState(1),i=10,[c,u]=a.useState(""),[v,L]=a.useState(""),[T,M]=a.useState(""),[I]=a.useState("12th");a.useEffect(()=>{if(n){const t=n.timeSlots.find(l=>l.isSelected)||n.timeSlots[0];h((t==null?void 0:t.id)||""),p([...n.assignedStudents]),j(""),x(1)}},[n]);const W=()=>{!c.trim()||!v.trim()||(p(t=>[{name:c.trim(),email:v.trim(),mobile:T.trim()||"+91 98000 00000",grade:I},...t]),u(""),L(""),M(""))},q=t=>{p(l=>l.filter(O=>O.email!==t))},C=a.useMemo(()=>{if(!g)return d;const t=g.toLowerCase();return d.filter(l=>l.name.toLowerCase().includes(t)||l.email.toLowerCase().includes(t)||l.mobile.toLowerCase().includes(t))},[d,g]),G=()=>{n&&S(n.id,b,d)},H=[{key:"name",header:"Student Name"},{key:"email",header:"Email"},{key:"mobile",header:"Mobile"},{key:"grade",header:"Grade",render:t=>s.jsx(N,{variant:"default",children:t.grade})},{key:"email",header:"Action",render:t=>s.jsx(ce,{onClick:()=>q(t.email),title:"Remove Student",children:s.jsx(F,{size:16})})}];return n?s.jsx(ee,{isOpen:e,onClose:r,title:`Modify Session - ${n.counselorName}`,subtitle:`Select preferred time slot and manage ${d.length} assigned students for ${n.counselorName}`,size:"xl",footer:s.jsxs("div",{style:{display:"flex",justifyContent:"flex-end",gap:"8px",width:"100%"},children:[s.jsx($,{variant:"secondary",onClick:r,disabled:m,children:"Cancel"}),s.jsxs($,{onClick:G,isLoading:m,children:["Save Changes (",d.length," Students)"]})]}),children:s.jsxs(se,{children:[s.jsxs("div",{children:[s.jsx(z,{children:"Available Time Slots (Select One)"}),s.jsx(te,{children:n.timeSlots.map(t=>{const l=t.id===b;return s.jsxs(oe,{$isSelected:l,onClick:()=>h(t.id),children:[s.jsx(re,{$isSelected:l,children:t.time}),l&&s.jsx(ne,{children:s.jsx(R,{size:14})})]},t.id)})})]}),s.jsxs("div",{children:[s.jsxs(ie,{children:[s.jsxs(z,{style:{margin:0},children:["Assigned Students (",d.length,")"]}),s.jsx("div",{style:{width:"260px"},children:s.jsx(f,{placeholder:"Search assigned students...",leftIcon:s.jsx(A,{size:15}),value:g,onChange:t=>{j(t.target.value),x(1)}})})]}),s.jsxs(ae,{children:[s.jsx(z,{style:{fontSize:"12px",marginBottom:"8px"},children:"Quick Add Student to Session"}),s.jsxs(de,{children:[s.jsx(f,{placeholder:"Student Name",value:c,onChange:t=>u(t.target.value)}),s.jsx(f,{placeholder:"Email Address",type:"email",value:v,onChange:t=>L(t.target.value)}),s.jsx(f,{placeholder:"Mobile Number",value:T,onChange:t=>M(t.target.value)}),s.jsx($,{size:"sm",variant:"secondary",leftIcon:s.jsx(D,{size:16}),onClick:W,children:"Add Student"})]})]}),s.jsx(le,{children:s.jsx(B,{columns:H,data:C,keyExtractor:t=>t.email,emptyMessage:"No students found.",pagination:{page:y,limit:i,total:C.length,totalPages:Math.ceil(C.length/i)||1,onPageChange:x}})})]})]})}):null},pe=o.div`
  display: flex;
  flex-direction: column;
`,me=o.div`
  display: flex;
