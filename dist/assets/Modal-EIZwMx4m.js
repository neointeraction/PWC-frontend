import{g as r,bi as b,r as d,q as u,j as e,bQ as f,bN as g,aJ as m}from"./index-DdWrmQ5m.js";const h=b`
  from { opacity: 0; }
  to { opacity: 1; }
`,y=r.div`
  position: fixed;
...
`,E=r.div`
  ...
  flex-shrink: 0;
`,L=({isOpen:o,onClose:t,title:a,subtitle:i,size:c="md",footer:n,children:x,closeOnBackdrop:p=!0})=>{const l=d.useCallback(s=>{s.key==="Escape"&&t()},[t]);return d.useEffect(()=>(o&&(document.addEventListener("keydown",l),document.body.style.overflow="hidden"),()=>{document.removeEventListener("keydown",l),document.body.style.overflow=""}),[o,l]),u.createPortal(e.jsx(f,{children:o&&e.jsx(y,{onClick:p?t:void 0,role:"dialog","aria-modal":"true","aria-labelledby":"modal-title",children:e.jsx(g.div,{initial:{opacity:0,scale:.95,y:8},animate:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.95,y:8},transition:{duration:.18,ease:"easeOut"},style:{width:"100%",display:"flex",justifyContent:"center"},onClick:s=>s.stopPropagation(),children:e.jsxs($,{$size:c,children:[(a||i)&&e.jsxs(k,{children:[e.jsxs("div",{children:[a&&e.jsx(v,{id:"modal-title",children:a}),i&&e.jsx(j,{children:i})]}),e.jsx(w,{onClick:t,"aria-label":"Close modal",children:e.jsx(m,{size:20})})]}),e.jsx(M,{children:e.jsx(C,{children:x})}),n&&e.jsx(E,{children:n})]})})})}),document.body)};export{L as M};
